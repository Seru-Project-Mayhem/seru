...
<!--                <p class="card-text"> Normal Price <span style="text-decoration: line-through">$${game.normalPrice}</span></p>-->
                    <p class="card-text" id="sale-price">$${game.salePrice}</p>
                    <button type="button" class="btn btn-light btn-sm mr-1 mb-2"><i class="fas fa-info-circle pr-2" id="details-btn" ></i>Details</button>
                </div>
            </div>
            <div class="flip-card-back" id="card-back">
                ...
                <p class="card-text" id="current-price"> Current Price $${game.salePrice}</p>
